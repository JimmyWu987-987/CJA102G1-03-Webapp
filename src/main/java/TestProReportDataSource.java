...
@WebServlet("/TestProReportDataSource")
public class TestProReportDataSource extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (conn != null) {
				...
				ResultSet rs = stmt.executeQuery("select * from pro_report");
				while (rs.next()) {
					out.println("No = " + rs.getInt(1));
					out.println("商品編號 = " + rs.getInt(3));
					out.println("標題 = "+rs.getString(6));
					out.println("內容 = "+rs.getString(7)+"\n");
